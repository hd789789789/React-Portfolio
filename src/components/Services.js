...
const Services = () => {
    const [header] = React.useState({
        mainHeader: 'SERVICES',
        text: 'Duis et veniam qui sit ullamco laboris' + 'Duis et veniam qui sit ullamco laboris.',
    ...
    const [state] = React.useState([
        {
            ...
            text:
                'Id consectetur adipisicing veniam adipisicing' +
    ...
    const listItems = state.map((info) => (
        <div className="col-4" key={info.id} data-aos="fade-up" data-aos-delay="200">
        ...
        <div className="services">
            <div className="container">
                <div className="services_header">
                    ...
                    <div className="row bgMain">{listItems}</div>
                </div>
            </div>
        </div>
    );
